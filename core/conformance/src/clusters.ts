...
// Utility clusters the firmware and SDK always provide for any device (identification,
// grouping, self-description, binding). A device definition is not expected to declare a
// capability for these, so conformance treats them as satisfied by the platform.
